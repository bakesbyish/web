  ...
  return (
    <div className="bg-white dark:bg-gray-800 flex flex-col items-center justify-center -mt-16">
        ...
        <div className="max-w-2xl mx-auto py-16 sm:py-24 lg:py-32 lg:max-w-none">
          ...
          <div className="mt-6 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-6">
            {collections.map((catergory, index: number) => (
							<Link href={`/collections/${catergory.catergorySlug}`} key={index} passHref>
      ...
      <Link href="/collections">
        <h1 className="text-center font-bold underline hover:cursor-pointer sm:-mt-16s">See all collections</h1>
      </Link>
    </div>
  );
};
