                ...
                <Disclosure.Panel>
                  ...
                  <form className="mt-10">
                    ...
                    <div className="flex space-x-4 mt-1">
                      ...
                      <button
                        type="submit"
                        className="bg-gray-200 text-sm font-medium text-gray-600 rounded-md px-4 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-rose-400"
                      >
                        Apply
                      </button>
                    </div>
        ...
        >
          <div className="max-w-lg mx-auto">
            ...
            <form>
              ...
              <button
                type="submit"
                className="w-full mt-6 bg-rose-400 border border-transparent rounded-md shadow-sm py-2 px-4 text-sm font-medium text-black hover:bg-rose-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-400"
              >
