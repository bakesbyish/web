      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 dark:border-gray-700 py-6 md:justify-start md:space-x-10">
          ...
          <div className="-mr-2 -my-2 md:hidden">
            <Popover.Button className="bg-white dark:bg-gray-700 rounded-md p-2 inline-flex items-center justify-center text-gray-400 dark:text-white/80 hover:text-gray-500 dark:hover:text-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
            ...
            <a
              href="#"
              className="text-base font-medium text-gray-500 dark:text-white/80 hover:text-gray-900 dark:hover:text-white"
            >
              Pricing
            </a>
            <a
                    ...
                    <ChevronDownIcon
                      className={classNames(
                        open
                          ? 'text-gray-600 dark:text-white'
                          : 'text-gray-400 dark:text-white/80',
                        'ml-2 h-5 w-5 group-hover:text-gray-500 dark:group-hover:text-white/80'
                      )}
                      aria-hidden="true"
                    />
                  </Popover.Button>
                    ...
                    <Popover.Panel className="absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
                      <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                        ...
                        <div className="px-5 py-5 bg-gray-50 dark:bg-gray-600 sm:px-8 sm:py-8">
                          <div>
                            <h3 className="text-sm tracking-wide font-medium text-gray-500 dark:text-white/80 uppercase">
                              Recent Posts
                            </h3>
                            <ul role="list" className="mt-4 space-y-4">
                              {recentPosts.map((post) => (
                                ...
                                >
                                  <a
                                    href={post.href}
                                    className="font-medium text-gray-900 dark:text-white hover:text-gray-700 dark:hover:text-white/80"
                                  >
                                    {post.name}
                                  </a>
                                </li>
                          ...
                          <div className="mt-5 text-sm">
                            <a
                              href="#"
                              className="font-medium text-rose-400 hover:text-indigo-500"
                            >
                              {' '}
                              View all posts{' '}
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a
              href="#"
              className="whitespace-nowrap text-base font-medium text-gray-500 dark:text-white/80 hover:text-gray-900 dark:hover:text-white"
            >
              Sign in
            </a>
            <a
              href="#"
              className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-slate-500 bg-rose-200 hover:bg-rose-400"
            >
              Sign up
            </a>
          </div>
          ...
          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white dark:bg-gray-700 divide-y-2 divide-gray-50">
            ...
            <div className="py-6 px-5 space-y-6">
              ...
              <div>
                <a
                  href="#"
                  className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-slate-500 bg-rose-200 hover:bg-rose-400"
                >
                  Sign up
                </a>
                <p className="mt-6 text-center text-base font-medium text-gray-500 dark:text-white/80">
                  Existing customer?{' '}
                  <a href="#" className="text-rose-400 hover:text-indigo-500">
                    Sign in
                  </a>
                </p>
              </div>
